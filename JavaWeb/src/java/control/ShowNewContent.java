 ...
 * @author ADMIN
 */
@WebServlet(name = "ShowNewContent", urlPatterns = {"/ShowNewContent"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String daySubmit = rs.getString("daysubmit");
                String title = rs.getString("title");
                String img = rs.getString("image");
                
                news.setIdNews(idNews);
                news.setIdAdmin(idAdmin);
                news.setDescription(description);
                news.setDaySubmit(daySubmit);
                news.setTitle(title);
                news.setImg(img);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/news-content.jsp");
